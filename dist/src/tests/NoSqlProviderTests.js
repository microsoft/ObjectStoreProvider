    ...
    provsToTest.forEach(function (provName) {
        describe('Provider: ' + provName, function () {
            ...
            describe('Data Manipulation', function () {
                ...
                it('Putting the same primary key should overwrite', function () { return __awaiter(_this, void 0, void 0, function () {
                    var objToPut, prov, retVal, ret;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                objToPut = { id: 'a', val: 'b' };
                                return [4 /*yield*/, openProvider(provName, {
                                        version: 1,
                                        stores: [
                                            {
                                                name: 'test',
                            ...
                            case 1:
                                prov = _a.sent();
                                return [4 /*yield*/, prov.put('test', objToPut)];
                            case 2:
                                _a.sent();
                                objToPut.val = 'c';
                                return [4 /*yield*/, prov.put('test', objToPut)];
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, prov.get('test', 'a')];
                            case 4:
                                retVal = _a.sent();
                                ret = retVal;
